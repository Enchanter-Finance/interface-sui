    ...
    <div class="popup__container">
      <div class="popup--wrapper flex align--center">
        ...
        <div class="popup--content">
          <div class="popup--text">Receive Exactly {{formatDecimalsNum(InCoin)}} {{selectedTokenTop.symbol}} and</div>
...
export default {
  setup(props, { emit }) {
    ...
    if(events.length){      
      ...
      OutCoin = toFixed(amountToDecimal(OutCoin,outDecimals))
    }else{
    }
    ...
    const onClose = () => store.commit(MutationType.SetShowTransactionRemovePopUp, false)
    return {
      onClose,
      selectedTokenBottom,
      selectedTokenTop,
